...
Finally, we compare the performance of RRBoost, L2Boost, LADBoost, MBoost, and Robloss. 
```{r compare, results='hide', cache=TRUE, message=FALSE}
...
We compare `value` (RMSE on the test set) of different methods and show that `model_RRBoost_cv_LADTree` is our best prediction model. 
```{r compare_val}
